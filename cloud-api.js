(function(){
  ...
  async function adminHeaders(extra={}){return publicHeaders(extra)}
  ...
  window.CloudAPI={configured,loadProducts,loadSettings,submitOrder,upsertProducts,deleteProduct,saveSettings,loadOrders,updateOrder,upload};
})();
